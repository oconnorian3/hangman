...
def startgame():
    startgame = print("How to play. Hangman is a simple word guessing game."
                      " Players try to figure out an unknown"
                      " word by guessing letters."
                      " If too many letters which"
                      " do not appear in the word are guessed,"
    ...
    while True:
        try:
            ...
            if name.isalpha():
                print(Fore.LIGHTGREEN_EX + 'Hi', Fore.LIGHTGREEN_EX +
                      name, Fore.LIGHTGREEN_EX + 'Lets play Hangman!')
                break
            else:
...
def hangman(): 
    ...
    while len(word_letter) > 0 and lives > 0:
        print("You have", lives, "lives left and the following"
